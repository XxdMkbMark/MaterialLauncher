...
interface LauncherApi {
    ...
    /** 写入指定实例的 extras 单个键（保留其它键）。 */
    suspend fun setInstanceExtra(instanceId: String, key: String, value: String)

    /** 删除指定实例的 extras 单个键（保留其它键）。 */
    suspend fun removeInstanceExtra(instanceId: String, key: String)
